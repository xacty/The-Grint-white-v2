function openNav() {
  ...
  $(document).ready(function() {
    ...
    setTimeout(() => {
      const box = document.getElementById('video-ban');
  ...
  }, 2520); // 👈️ time in milliseconds

    $("#banner-left").delay(2350).queue(function(next) {
      $(this).addClass("appear");
      next();
    });
    $("#banner-right").delay(2220).queue(function(next) {
      $(this).addClass("appear");
      next();
    });
